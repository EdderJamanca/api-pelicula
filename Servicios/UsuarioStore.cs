...
namespace minimalApi.Servicios
{
    public class UsuarioStore : IUserStore<IdentityUser>, IUserEmailStore<IdentityUser>, IUserPasswordStore<IdentityUser>,IUserClaimStore<IdentityUser>
    {
        ...
        {
            await repositorioUsuario.AsignarClaims(user, claims);
        }

        public async Task<IdentityResult> CreateAsync(IdentityUser user, CancellationToken cancellationToken)
        {
            user.Id = await repositorioUsuario.Crear(user);
        ...
        {
            return await repositorioUsuario.ObtenerClaims(user); 
        }
        ...
        {
            await repositorioUsuario.RemoveClaims(user, claims);
        }
